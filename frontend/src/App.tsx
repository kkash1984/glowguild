...
export default function App(){
  ...
  return(
    <div style={s.page}>
      <div style={s.header}><div><div style={s.title}>🛡️ GlowGuild</div><div style={{fontSize:13,color:"#64748b"}}>On-chain guild system • {total?.toString()??0} members</div></div><ConnectButton/></div>
